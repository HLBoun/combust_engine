...
namespace cmbst 
{
      ...
      const PipelineConfigInfo& configInfo)
  {
    ...
    auto bindingDescriptions = CmbstModel::Vertex::getBindingDescriptions();
    auto attributeDescriptions = CmbstModel::Vertex::getAttributeDescriptions();
  ...
  void CmbstPipeline::createShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule)
  {
    ...
    if (vkCreateShaderModule(cmbstDevice.device(), &createInfo, nullptr, shaderModule) != VK_SUCCESS)
    {
  ...
  void CmbstPipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo)
  {
